...
In this blog post, I will demonstrate how to perform image classification using Tensorflow, and performing and explaining concepts such as datasets, data augmentation, and transfer learning.
...
![Figure of Cats on Top Row, Dogs on Bottom Row](/images/output_8_1.png)
...
![Figure of Dog doing a frontflip (not really his picture is just rotating)](output_27_0.png)
